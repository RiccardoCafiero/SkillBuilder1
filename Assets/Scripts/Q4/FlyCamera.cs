...
public class FlyCamera : MonoBehaviour {
    ...
    [SerializeField] float camSens = 0.15f; //How sensitive it with mouse
    private Vector3 lastMouse = new Vector3(255, 255, 255); //kind of in the middle of the screen, rather than at the top (play)
    private float totalRun= 1.0f;

    [SerializeField] bool cameraMovementActive = false;
    [SerializeField] bool cameraKeyboardMovementActive = false;
    ...
    void Update () {
        ...
        if (cameraKeyboardMovementActive)
        {
            //Keyboard commands
            float f = 0.0f;
